...
<body style="margin: 0;">
    ...
    <div class="container" style="margin-top:100px">
        <div>
            <h1 style="font-weight: bold;">ประวัติการสั่งซื้อ</h1>
        </div>
            ...
            xhttp.onreadystatechange = function() {
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    for (i = 0; i < JSF.length; i++) {
                        ...
                        text += '<td>' + (JSF[i].status == 1 ? "<span class='badge badge-success'>ชำระเงินแล้ว</span>" : "<span class='badge badge-danger'>รอการชำระเงิน</span>") + '</td>';
